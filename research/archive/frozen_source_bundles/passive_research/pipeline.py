...
from passive_research.analysis import analyze_stage
from passive_research.labeling import label_probe_file
from passive_research.manual_audit import build_manual_audit
from passive_research.placements import build_placements
...
SOURCE_PATHS = (
    ROOT / "cpp/app/tardis_passive_main.cpp",
    ROOT / "cpp/research/passive_queue.cpp",
    ROOT / "cpp/research/passive_queue.hpp",
    ROOT / "passive_research/analysis.py",
    ROOT / "passive_research/labeling.py",
    ROOT / "passive_research/placements.py",
    ROOT / "passive_research/pipeline.py",
)
...
def _validate_frozen() -> dict[str, Any]:
