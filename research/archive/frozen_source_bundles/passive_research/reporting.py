...
from passive_research.analysis import hac_mean_se
from research.evaluate import sha256, write_csv, write_json
...
.venv/bin/python -m passive_research.pipeline stage-a
.venv/bin/python -m passive_research.pipeline development
.venv/bin/python -m passive_research.pipeline validation
.venv/bin/python -m passive_research.pipeline holdout
.venv/bin/python -m passive_research.reporting --code-commit {code_commit}
```
